...
public class ImportadorDeGastos {
    ...
    public List<Gasto> importa(InputStream entrada) throws ParseException {
        ...
        while (leitor.hasNextLine()) {
            ...
            Calendar dataNascimento = convertDataTxtParaCalendar(dataNascTxt);
            Calendar dataDespesa = convertDataTxtParaCalendar(dataGastoTxt);
    ...
    private Calendar convertDataTxtParaCalendar(String dataNascTxt) throws ParseException {
